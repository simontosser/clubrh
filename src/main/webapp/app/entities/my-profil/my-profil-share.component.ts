...
import { ShareProfil } from './../share-profil/share-profil.model';
import { ShareProfilService } from './../share-profil/share-profil.service';
import { ITEMS_PER_PAGE, Principal } from '../../shared';

@Component({
    selector: 'jhi-my-profil-share',
    templateUrl: './my-profil-share.component.html'
})
export class MyProfilShareComponent implements OnInit, OnDestroy {
...
currentAccount: any;
    ...
    loadAll() {
        if (this.currentSearch) {
            this.shareProfilService.search({
                page: this.page - 1,
                query: this.currentSearch,
                size: this.itemsPerPage,
                sort: this.sort()}).subscribe(
                    (res: HttpResponse<ShareProfil[]>) => this.onSuccess(res.body, res.headers),
