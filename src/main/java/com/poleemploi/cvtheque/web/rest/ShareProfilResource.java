...
public class ShareProfilResource {
	 ...
	 *
	 * @param shareProfilDTO
	 *            the shareProfilDTO to create
	 * @return the ResponseEntity with status 201 (Created) and with body the
	 *         new shareProfilDTO, or with status 400 (Bad Request) if the
	 *         shareProfil has already an ID
	 * @throws URISyntaxException
	 *             if the Location URI syntax is incorrect
	 */
	@PostMapping("/share-profils")
	@Timed
	public ResponseEntity<ShareProfilDTO> createShareProfil(@Valid @RequestBody ShareProfilDTO shareProfilDTO)
			throws URISyntaxException {
	 ...
	 *
	 * @param shareProfilDTO
	 *            the shareProfilDTO to update
	 * @return the ResponseEntity with status 200 (OK) and with body the updated
	 *         shareProfilDTO, or with status 400 (Bad Request) if the
	 *         shareProfilDTO is not valid, or with status 500 (Internal Server
	 *         Error) if the shareProfilDTO couldn't be updated
	 * @throws URISyntaxException
	 *             if the Location URI syntax is incorrect
	 */
	@PutMapping("/share-profils")
	@Timed
	public ResponseEntity<ShareProfilDTO> updateShareProfil(@Valid @RequestBody ShareProfilDTO shareProfilDTO)
			throws URISyntaxException {
	 ...
	 *
	 * @param id
	 *            the id of the shareProfilDTO to retrieve
	 * @return the ResponseEntity with status 200 (OK) and with body the
	 *         shareProfilDTO, or with status 404 (Not Found)
	 */
	 ...
	 *
	 * @param id
	 *            the id of the shareProfilDTO to delete
	...
	/**
	 * SEARCH /_search/share-profils?query=:query : search for the shareProfil
	 * corresponding to the query.
	 *
	 * @param query
	 *            the query of the shareProfil search
	 * @param pageable
	 *            the pagination information
